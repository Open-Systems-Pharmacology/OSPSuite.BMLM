...
<u>uncensored data points</u>
   ...
   $$log(\mathcal{L}u_{i,j}(\theta,\mathbf {y})) =  -\frac{1}{2}\sum_{t_u}\left( \frac{-(\mathbf{y}_{i,j}(t) - f_{i,j}(\theta,t))^2.}{\epsilon_j^2} - log(2\pi * \epsilon_j^2)\right)$$
...
<u>uncensored data points</u>
   ...
   $$log(\mathcal{L}u_{i,j}(\theta,\mathbf {y})) =  -\frac{1}{2}\left( \frac{-(\mathbf{y}_{i,j}(t) - f_{i,j}(\theta,t_u))^2.}{\epsilon_j*f_{i,j}(\theta,t)^2} - log(2\pi * \epsilon_j^2)\right)$$
...
#### logarithmic
   ...
   $$log(\mathcal{L}u_{i,j}(\theta,\mathbf {y})) =  -\frac{1}{2}\sum_{t_u}\left( \frac{-(log(\mathbf{y}_{i,j}(t)) - log(f_{i,j}(\theta,t)))^2.}{\epsilon_j^2} - log(2\pi*\epsilon_j*d_{i,j}(t)(t_u)^2)\right)$$
